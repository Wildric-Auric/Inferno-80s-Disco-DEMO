...
public class PlayerController2D : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        //Flip Charachter
        var srTrans = sr.transform;
        srTrans.localScale = new Vector3(Mathf.Clamp(srTrans.localScale.x + smoothFlip * movement1, -initialSize, initialSize), srTrans.localScale.y, sr.transform.localScale.z);
        //Update position
